...
const sharedPhases = [
  ...
  },
  {
    ...
    modules: [
      { id: "s1", label: "Week 07", title: "Measurement before optimization", topics: ["Throughput vs. latency vs. utilization", "p50/p95/p99 and tail amplification", "Warm-up, JIT effects, measurement noise", "Coordinated omission and realistic load", "Baseline capacity and bottleneck hypotheses"], practice: "Load-test one concurrent service you own under a reproducible workload.", proof: "Baseline report with workload, percentiles, resource use, and three evidence-backed hypotheses." },
      { id: "s2", label: "Week 08", title: "CPU, memory, and runtime behavior", topics: ["Flame graphs and hot-path analysis", "Allocation rate, heap pressure, and object lifetime", "Garbage collection and pause behavior across runtimes", "CPU caches, locality, false sharing", "JFR, async-profiler, and allocation profiling", "Profiling beyond the JVM: perf, py-spy, and GPU utilization basics"], practice: "Find and fix one CPU or allocation bottleneck without changing behavior.", proof: "Before/after traces plus an explanation of why the change worked." },
