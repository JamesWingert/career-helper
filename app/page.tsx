...
const branches: Branch[] = [
  {
    ...
    targets: ["AI Deployment Engineer", "Forward Deployed Software Engineer", "Forward Deployed AI Engineer", "Forward Deployed Infrastructure Engineer", "Forward Deployed Reliability Engineer", "Applied AI Engineer", "AI Solutions Engineer", "Customer Engineer — AI/ML", "Solutions Engineer — AI/ML", "AI Implementation Engineer", "Technical Consultant — AI", "GenAI Solutions Architect"],
    ...
    modules: [
      ...
      { id: "fde2", label: "Module 02", title: "Rapid unfamiliar-system integration", topics: ["New SaaS/API in hours, not weeks", "Schema inspection and data mapping", "Identity, permissions, and tenant boundaries", "Legacy constraints and compatibility shims", "Prototype debt that must be removed"], practice: "Connect three systems you have never used into one workflow.", proof: "Working integration plus an honest productionization gap list." },
      ...
      { id: "fde4", label: "Module 04", title: "Deployment and operational readiness", topics: ["Customer network and data constraints", "Observability across model and tools", "Fallbacks, escalation, and support model", "Security/governance review", "Launch checklist and owner handoff"], practice: "Prepare the workflow for a hostile enterprise environment.", proof: "Readiness review with launch blockers, owners, SLOs, and rollback." },
      { id: "fde5", label: "Module 05", title: "Demo, objection, and change-request handling", topics: ["Executive problem framing", "Technical architecture defense", "Live failure demonstration", "Handling contradictory stakeholder requests", "Separating immediate changes from roadmap work"], practice: "Run a demo, then accept a surprise requirement and an objection.", proof: "Recorded 10-minute demo and a revised delivery plan." },
      { id: "fde6", label: "Module 06", title: "Outcome, adoption, and product feedback", topics: ["Usage and workflow completion", "Quality and human acceptance", "Time or revenue impact", "Reusable patterns vs. customer-specific code", "Feedback that should change the core product"], practice: "Define how a deployment proves durable value after launch.", proof: "30/60/90-day adoption scorecard and product feedback memo." },
    ],
  },
  {
    ...
    targets: ["AI Platform Engineer", "ML Platform Engineer", "ML Infrastructure Engineer", "AI Infrastructure Engineer", "Inference Platform Engineer", "Model Serving Engineer", "LLM Infrastructure Engineer", "GenAI Platform Engineer", "ML Systems Engineer", "MLOps Platform Engineer", "Evaluation Platform Engineer", "Training Infrastructure Engineer", "Feature Platform Engineer", "Distributed Systems Engineer — ML", "AI Reliability Engineer"],
    ...
    modules: [
      ...
      { id: "p5", label: "Module 05", title: "GPU and distributed inference fundamentals", topics: ["GPU memory and utilization", "Quantization and model compression", "Tensor, pipeline, and data parallelism", "KV-cache and context-length economics", "Scheduler fairness and multi-tenant isolation"], practice: "Model the resource plan for a large-model serving workload.", proof: "Capacity and cost model with bottlenecks and scaling limits." },
  ...
  },
  {
    ...
    targets: ["GenAI Engineer", "LLM Engineer", "Applied AI Engineer", "AI Product Engineer", "LLM Evaluation Engineer", "AI Evaluation Engineer", "AI Quality Engineer", "AI Reliability Engineer", "Agent Infrastructure Engineer", "RAG / Retrieval Engineer", "AI Systems Engineer", "AI Safety Engineer — Evals", "AI Product Infrastructure Engineer", "LLM Platform Engineer"],
    ...
    modules: [
      ...
      { id: "g3", label: "Module 03", title: "Tools, agents, and workflow state", topics: ["Tool selection and argument validation", "State machines vs. open-ended loops", "Idempotent side effects", "Long-running work and recovery", "Human approval and escalation"], practice: "Implement one bounded, recoverable tool-using workflow.", proof: "Trace-based tests for success, denial, timeout, retry, and resume." },
  ...
  },
  {
    ...
    targets: ["Quantitative Developer", "Quantitative Software Engineer", "Electronic Trading Developer", "Algorithmic Trading Engineer", "Trading Systems Engineer", "Software Engineer — Trading Strategies", "Software Engineer — Automated Trading Systems", "Market Data Engineer", "Exchange Connectivity Engineer", "Execution Engineer", "Low-Latency Software Engineer", "Front-Office Developer", "Desk Developer", "Strats Developer", "Quant Platform Engineer", "Research Infrastructure Engineer", "Pricing & Risk Developer", "Trading Infrastructure Engineer", "Trading Production Engineer"],
    ...
    modules: [
      ...
      { id: "q3", label: "Module 03", title: "Market data systems", topics: ["Trades, quotes, depth, and reference data", "Snapshots, incremental updates, and sequence numbers", "Gap detection, recovery, and replay", "Event time, receive time, and clock synchronization", "FIX, ITCH/OUCH, multicast, and binary protocols conceptually"], practice: "Build a feed handler that reconstructs a book and recovers gaps.", proof: "Deterministic replay tests including duplicates, loss, and reordering." },
      { id: "q4", label: "Module 04", title: "Order management and execution", topics: ["Order state machines and acknowledgments", "Exchange gateways and session recovery", "Pre-trade risk and kill switches", "Execution algorithms: TWAP, VWAP, participation", "Slippage, transaction cost, and fill quality"], practice: "Add an order gateway, risk checks, and one simple execution algorithm.", proof: "State-transition tests and execution-quality report." },
      ...
      { id: "q11", label: "Module 11", title: "Positions, P&L, and risk", topics: ["Positions, cash, realized and unrealized P&L", "Exposure, limits, and concentration", "Hedging and Greeks at a conceptual level", "Drawdown, volatility, and scenario stress", "Reconciliation and end-of-day controls"], practice: "Add position/P&L tracking and risk limits to the simulator.", proof: "Tests for fills, fees, marks, limit breaches, and reconciliation." },
      { id: "q12", label: "Module 12", title: "Trading-engineering capstone", topics: ["Feed → book → strategy → risk → gateway → fills", "Replay and disaster recovery", "Load and latency testing", "Operational dashboards and kill switch", "Architecture and failure-mode defense"], practice: "Integrate the complete event-driven trading simulator.", proof: "Working system, benchmark report, architecture document, and deep-dive demo." },
    ],
  },
];
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="overview">
      <article className="why"><span className="eyebrow">WHY THE SHARED CORE EXISTS</span><h3>It trains the layer common to every path.</h3><p>Performance diagnosis, statistical judgment, integration failure, and architecture decisions show up in AI platform, GenAI/evals, FDE, and trading engineering. The core gives you 12 weeks of reusable work before you spend months on a narrower domain.</p><p className="skip"><b>Already covered by your résumé:</b> Python, AWS deployment, ML pipelines, model serving, streaming, distributed systems, LLM integration, and production reliability.</p></article>
